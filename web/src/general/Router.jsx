  ...
  [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'p115', loader: () => redirect(RoutePaths.MEDIA_CONFIG) },
        { path: RoutePaths.MEDIA_PROXY.slice(1),       loader: () => redirect(RoutePaths.MEDIA_CONFIG) },
        { path: RoutePaths.MEDIA_CONFIG.slice(1),      element: <P115 /> },
        { path: RoutePaths.MEDIA_ACTOR.slice(1),       element: <ActorPage /> },
        { path: RoutePaths.MEDIA_GAPS.slice(1),        element: <Gaps /> },
        { path: RoutePaths.MEDIA_CALENDAR.slice(1),    element: <Calendar /> },
        ...
        { path: 'actor', loader: () => redirect(RoutePaths.MEDIA_ACTOR) },
        { path: 'gaps', loader: () => redirect(RoutePaths.MEDIA_GAPS) },
        { path: 'calendar', loader: () => redirect(RoutePaths.MEDIA_CALENDAR) },
